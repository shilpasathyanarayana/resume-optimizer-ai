...
async def handle_webhook_event(
    ...
    invoice.payment_succeeded   → refresh period dates on renewal
...
async def _sync_subscription(
    ...
    """
    Writes Stripe subscription state to our DB row.
    subscriptions table only — does NOT touch users.plan.
    """
